...
def step_click_checkout(context):
    ...
    assert context.checkout_step_one.is_on_checkout_form(), \
...
def step_verify_on_overview_page(context):
    ...
    assert context.checkout_step_two.is_on_checkout_overview_page(), \
...
def step_verify_product_in_summary(context, product_name):
    ...
    assert context.checkout_step_two.is_product_in_summary(product_name), \
...
def step_verify_payment_info(context):
    ...
    assert context.checkout_step_two.is_payment_info_displayed(), \
...
def step_verify_shipping_info(context):
    ...
    assert context.checkout_step_two.is_shipping_info_displayed(), \
...
def step_verify_order_confirmation(context):
    ...
    assert context.checkout_complete.is_on_confirmation_page(), \
