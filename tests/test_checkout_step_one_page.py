...
class TestCheckoutStepOnePageLocators:
    ...
    def test_checkout_info_container_locator(self):
        ...
        assert CheckoutStepOnePage.CHECKOUT_INFO_CONTAINER == (By.CLASS_NAME, "checkout_info")
...
class TestIsOnCheckoutForm:
    ...
    def test_is_on_checkout_form_returns_true_when_container_present(self):
        ...
        with patch.object(page, 'is_element_present', return_value=True) as mock_is_present:
            ...
            mock_is_present.assert_called_once_with(CheckoutStepOnePage.CHECKOUT_INFO_CONTAINER, timeout=5)
...
class TestEnterFirstName:
    ...
    def test_enter_first_name_calls_type_with_first_name_locator(self):
        ...
        with patch.object(page, 'type') as mock_type:
            ...
            mock_type.assert_called_once_with(CheckoutStepOnePage.FIRST_NAME_INPUT, "John")
...
class TestEnterLastName:
    ...
    def test_enter_last_name_calls_type_with_last_name_locator(self):
        ...
        with patch.object(page, 'type') as mock_type:
            ...
            mock_type.assert_called_once_with(CheckoutStepOnePage.LAST_NAME_INPUT, "Doe")
...
class TestEnterZipCode:
    ...
    def test_enter_zip_code_calls_type_with_zip_code_locator(self):
        ...
        with patch.object(page, 'type') as mock_type:
            ...
            mock_type.assert_called_once_with(CheckoutStepOnePage.ZIP_CODE_INPUT, "12345")
...
class TestGetErrorMessage:
    ...
    def test_get_error_message_returns_text(self):
        ...
        with patch.object(page, 'get_text', return_value="Error: First Name is required") as mock_get_text:
