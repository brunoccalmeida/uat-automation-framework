...
class TestCheckoutStepTwoPageLocators:
    ...
    def test_checkout_summary_container_locator(self):
        ...
        assert CheckoutStepTwoPage.CHECKOUT_SUMMARY_CONTAINER == (By.ID, "checkout_summary_container")
    
    def test_subtotal_label_locator(self):
        """SUBTOTAL_LABEL locator should use correct class name."""
        assert CheckoutStepTwoPage.SUBTOTAL_LABEL == (By.CLASS_NAME, "summary_subtotal_label")
...
class TestIsOnCheckoutOverviewPage:
    ...
    def test_is_on_checkout_overview_page_returns_true_when_container_present(self):
        ...
        with patch.object(page, 'is_element_present', return_value=True) as mock_is_present:
            ...
            mock_is_present.assert_called_once_with(CheckoutStepTwoPage.CHECKOUT_SUMMARY_CONTAINER, timeout=3)
