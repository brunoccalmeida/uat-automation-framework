...
class TestInventoryPageLocators:
    ...
    def test_shopping_cart_badge_locator(self):
        ...
        assert InventoryPage.SHOPPING_CART_BADGE == (By.CLASS_NAME, "shopping_cart_badge")
...
class TestIsOnInventoryPage:
    ...
    def test_is_on_inventory_page_returns_true_when_container_present(self):
        ...
        with patch.object(page, 'is_element_present', return_value=True) as mock_is_present:
            ...
            mock_is_present.assert_called_once_with(InventoryPage.INVENTORY_CONTAINER, timeout=3)
...
class TestGetProductCount:
    ...
    def test_get_product_count_returns_correct_count(self):
        ...
        mock_driver.find_elements.assert_called_once_with(*InventoryPage.INVENTORY_ITEMS)
        assert result == 6
